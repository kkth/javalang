...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            //client.setUploadCreationURL(new URL("http://172.20.33.7:1080/files"));
            client.setUploadCreationURL(new URL("http://172.20.33.7:1080/files/da9035107b7fa349e985cc17c14cb7ec"));
            client.setUploadCreationURL(new URL(""));
            ...
            //File file = new File("/Users/kunhe/MyProjects/tus/tus-java-client/example/assets/prairie.jpg");
            File file = new File("/Users/kunhe/tmp/word106.app");
